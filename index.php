            ...
            <div class="col-md-12">
                <div class="testimonials owl-carousel">
                    <div class="single-testimonial">
                        <div class="testi-img">
                            <img src="<?php echo get_template_directory_uri() . '/assets/img/testimonials/03.png' ?>"
                                alt="" />
                        </div>
                        <p>" Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad assumenda culpa cumque
                            dicta sint soluta voluptas eius iusto modi reprehenderit sint soluta voluptas. "</p>
                        <h4>john doe <span>web developer</span></h4>
                    </div>
                    <div class="single-testimonial">
                        <div class="testi-img">
                            <img src="<?php echo get_template_directory_uri() . '/assets/img/testimonials/01.png' ?>"
                                alt="" />
                        </div>
                        <p>" Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad assumenda culpa cumque
                            dicta sint soluta voluptas eius iusto modi reprehenderit sint soluta voluptas. "</p>
                    ...
                    <div class="single-testimonial">
                        <div class="testi-img">
                            <img src="<?php echo get_template_directory_uri() . '/assets/img/testimonials/04.png' ?>"
                                alt="" />
                        </div>
                        <p>" Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad assumenda culpa cumque
                            dicta sint soluta voluptas eius iusto modi reprehenderit sint soluta voluptas. "</p>
                    ...
                    <div class="single-testimonial">
                        <div class="testi-img">
                            <img src="<?php echo get_template_directory_uri() . '/assets/img/testimonials/02.png' ?>"
                                alt="" />
                        </div>
                        <p>" Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad assumenda culpa cumque
                            dicta sint soluta voluptas eius iusto modi reprehenderit sint soluta voluptas. "</p>
            ...
            <div class="col-md-4">
                <div class="single-blog">
                    ...
                    <div class="post-content">
                        ...
                        <p>Phasellus consectetuer vestibulum elit. Aenean tellus metus, bibendum sed, posuere ac,
                            mattis non, nunc. Vestibulum fringilla pede sit amet augue. In turpis.</p>
                        <a href="#" class="box-btn">read more <i class="fa fa-angle-double-right"></i></a>
                    </div>
                </div>
            </div>
